...
export default function Register() {
  ...
  return (
    ...
    {/* Formulário */}
    <div className="w-full lg:w-1/2 flex flex-col p-4 md:p-6 lg:p-10 overflow-y-auto max-h-screen">
      <div className="max-w-md mx-auto w-full flex flex-col h-full">
        ...
        <div className="w-full flex flex-col flex-grow justify-center items-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 w-full">
            ...
            <div>
              <Label htmlFor="password_confirmation" className="mb-2 block">Confirmar Senha</Label>
              <div className="relative">
                <Input
                  type={showPassword ? "text" : "password"}
        ...
        <div className="mt-auto pt-6 pb-6 text-xs md:text-sm text-gray-500">
